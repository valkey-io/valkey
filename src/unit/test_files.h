...
unitTest __test_cmd_offload_c[] = {{"test_getSlotQueue", test_getSlotQueue}, {"test_requiresServerExclusivity", test_requiresServerExclusivity}, {"test_canCommandBeOffloaded", test_canCommandBeOffloaded}, {"test_slotQueueRefCounting", test_slotQueueRefCounting}, {"test_threadDeferredJobs", test_threadDeferredJobs}, {"test_slotQueueAddJobAndDispatch", test_slotQueueAddJobAndDispatch}, {"test_canExecuteCommand", test_canExecuteCommand}, {"test_yieldForBusySlot", test_yieldForBusySlot}, {"test_slotQueueRemoveClient", test_slotQueueRemoveClient}, {"test_ioThreadsOnUnlinkClient", test_ioThreadsOnUnlinkClient}, {"test_isServerCronDeferred", test_isServerCronDeferred}, {"test_updateOffloadingThrottle", test_updateOffloadingThrottle}, {"test_prefetchSlotQueueInfo", test_prefetchSlotQueueInfo}, {"test_updateOffloadingSaturation", test_updateOffloadingSaturation}, {"test_canExecuteCommandAdvanced", test_canExecuteCommandAdvanced}, {"test_isSlotExclusiveCmd", test_isSlotExclusiveCmd}, {"test_createJobNodeAndProcessOrAddJob", test_createJobNodeAndProcessOrAddJob}, {"test_processDeferredJobsList", test_processDeferredJobsList}, {"test_slotQueueRemoveClientFromGlobalQueue", test_slotQueueRemoveClientFromGlobalQueue}, {"test_updateOffloadingThrottleBoundaries", test_updateOffloadingThrottleBoundaries}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_cmd_offload.c", __test_cmd_offload_c},
