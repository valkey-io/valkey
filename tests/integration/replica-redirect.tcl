start_server {tags {needs:repl external:skip}} {
    start_server {} {
        ...
        test {CLIENT INFO} {
            r client info
        } {id=* addr=*:* laddr=*:* fd=* name=* age=* idle=* flags=N qos=* capa=r db=* sub=0 psub=0 ssub=0 multi=-1 watch=0 qbuf=0 qbuf-free=* argv-mem=* multi-mem=0 rbs=* rbp=* obl=0 oll=0 omem=0 tot-mem=* events=r cmd=client|info user=* redir=-1 resp=* lib-name=* lib-ver=* tot-net-in=* tot-net-out=* tot-cmds=*}
