...
start_cluster 5 10 {tags {external:skip cluster cluster-raft:skip} overrides {cluster-ping-interval 1000 cluster-node-timeout 5000}} {
...
# slaves for each master.
start_cluster 3 15 {tags {external:skip cluster cluster-raft:skip} overrides {cluster-ping-interval 1000 cluster-node-timeout 5000}} {
