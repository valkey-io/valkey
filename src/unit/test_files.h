...
unitTest __test_object_c[] = {{"test_object_with_key", test_object_with_key}, {"test_embedded_string_with_key", test_embedded_string_with_key}, {"test_embedded_string_with_key_and_expire", test_embedded_string_with_key_and_expire}, {"test_embedded_value", test_embedded_value}, {"test_unembed_value", test_unembed_value}, {"test_metadata_disabled", test_metadata_disabled}, {"test_metadata_without_key", test_metadata_without_key}, {"test_metadata_with_key", test_metadata_with_key}, {"test_metadata_read_write", test_metadata_read_write}, {"test_metadata_multiple_objects", test_metadata_multiple_objects}, {NULL, NULL}};
