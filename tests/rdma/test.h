/* ==========================================================================
 * test.h - shared CLI and helpers for Valkey Over RDMA test clients
 * --------------------------------------------------------------------------
...
static inline int rdmaTestParseIntRange(const char *name, const char *value, long min, long max) {
    char *end = NULL;
    long val;
...
static inline void rdmaTestParseArgs(int argc, char **argv, rdma_test_config *cfg) {
...
static inline void rdmaTestFormatThreadKey(char *buf, size_t len, int tid, int index) {
    snprintf(buf, len, "THREAD%02d-%06d", tid, index);
}

static inline void rdmaTestFormatClientSeqKey(char *buf, size_t len, int client, long long seq) {
...
static inline int rdmaTestValueEquals(const char *got, size_t gotlen, const char *expected, size_t expectedlen) {
