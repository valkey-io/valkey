...
unitTest __test_expiry_set_c[] = {{"test_expiry_set_add", test_expiry_set_add}, {"test_expiry_set_refresh_count", test_expiry_set_refresh_count}, {"test_expiry_set_remove_existing", test_expiry_set_remove_existing}, {"test_expiry_set_exists", test_expiry_set_exists}, {"test_expiry_set_exists_auto_expire", test_expiry_set_exists_auto_expire}, {"test_expiry_set_getexpiry", test_expiry_set_getexpiry}, {"test_expiry_set_getexpiry_auto_expire", test_expiry_set_getexpiry_auto_expire}, {"test_expiry_set_remove_nonexistent", test_expiry_set_remove_nonexistent}, {"test_expiry_set_expire", test_expiry_set_expire}, {"test_expiry_set_count_triggers_expire", test_expiry_set_count_triggers_expire}, {"test_expiry_set_out_of_order_insert", test_expiry_set_out_of_order_insert}, {"test_expiry_set_refresh_triggers_reorder", test_expiry_set_refresh_triggers_reorder}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_expiry_set.c", __test_expiry_set_c},
