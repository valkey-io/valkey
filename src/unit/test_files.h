...
unitTest __test_hashtab_c[] = {{"test_cursor", test_cursor}, {"test_set_hash_function_seed", test_set_hash_function_seed}, {"test_add_and_find", test_add_and_find}, {"test_scan", test_scan}, {"test_iterator", test_iterator}, {"test_safe_iterator", test_safe_iterator}, {"test_probing_chain_length", test_probing_chain_length}, {NULL, NULL}};
