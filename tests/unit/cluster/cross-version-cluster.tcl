...
tags {external:skip needs:other-server cluster singledb cluster-v2:skip} {
    test "Cross version cluster - failover" {

        # Test cluster failover on shutdown is prevented when old replicas exist
        start_cluster 3 1 {tags {external:skip cluster cluster-v2:skip} overrides {cluster-ping-interval 1000}} {
