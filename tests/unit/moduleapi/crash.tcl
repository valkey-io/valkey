...
if {!$::valgrind} {
    start_server {tags {"modules"}} {
        ...
        test {Test module crash when info crashes with an assertion } {
            ...
            set res [wait_for_log_messages 0 {"*=== VALKEY BUG REPORT START: Cut & paste starting from here ===*"} 0 10 1000]
            ...
            wait_for_log_messages 0 {"*=== VALKEY BUG REPORT END. Make sure to include from START to END. ===*"} $loglines 10 1000
            assert_equal 1 [count_log_message 0 "=== VALKEY BUG REPORT END. Make sure to include from START to END. ==="]
            ...
            assert_equal 1 [count_log_message 0 "=== VALKEY BUG REPORT START: Cut & paste starting from here ==="]
        }
    }
